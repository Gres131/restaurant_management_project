...
RESTAURANT_MAPS_API_KEY = os.getenv("RESTAURANT_MAPS_API_KEY", "")
...
RESTAURANT_ADDRESS = "123 MG Road, Bengaluru, India"
...
RESTAURANT_EMAIL = os.getenv("RESTAURANT_EMAIL", "restaurantowner@example.com")